#!/usr/bin/env python3
"""独立脚本：指定 box_id + camera_id，拉直播 RTSP，每 N 秒存 1 帧到 OSS。"""
...
def run(box_id: str, camera_id: str, duration: int | None = None) -> int:
    ...
    print(f"OSS : oss://{OSS_BUCKET}/{prefix}/")
...
if __name__ == "__main__":
    ...
    p.add_argument("--camera_id", default="DS-2CD3786G2-IZS20230731AAWRAE4588060")
    ...
    if args.list:
        ...
        sys.exit(0)
    try:
        run(args.box_id, args.camera_id, args.duration)
